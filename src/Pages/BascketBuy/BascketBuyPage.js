    ...
    <div className={BascketBuyPagestyle.divMainPage}>
      <div className={BascketBuyPagestyle.DivmainSection}>
        <div className={BascketBuyPagestyle.divSubjectSection}>
          ...
          <span className={BascketBuyPagestyle.textAprowContinue} onClick={()=>setShowModal(true)}>
        ...
        {ShowModal && <InfoCustomerModal setShowModal={setShowModal} TotPrices={TotPrices} />}
      </div>
    </div>
  );
};
